...
public class AES_test10 {
    public static void main(String[] args) throws Exception {
        ...
        String ciphertext = using_aes.AES_encrypt(plaintext[k], key, mode); //加密
        AVEE = (System.nanoTime() - timing);
        System.out.println("It takes " + df.format(AVEE) + "\t nanoseconds."); //輸出所花時間
        ...
        AVED = (System.nanoTime() - timing);
        System.out.println("It takes " + df.format(AVED) + "\t nanoseconds."); //輸出所花時間
        //System.out.println("The Decrypted Plaintext :\n" + decrypttext); //輸出解密結果
        timee += AVEE;
        timed += AVED;
        }

        System.out.println("\n\n Average of ENCRYPTING Time " + df.format(timee) + "\t nanoseconds."); 
        System.out.println("\n  Average of DECRYPTING Time " + df.format(timed) + "\t nanoseconds.");  
    }
}